<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 travellers__grid">
    <div class="da relative flex min-h-screen justify-center overflow-hidden mt-8 travellers_card">
