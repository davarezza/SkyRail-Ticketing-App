    ...
    <div class="max-w-screen-lg mx-auto px-4">
        <div class="flex items-center justify-between h-16">
            ...
            <ul class="hidden md:flex items-center gap-8">
                ...
                <li><a href="{{ route('booking.page') }}" class="font-medium {{ request()->routeIs('booking.page') ? 'text-blue-600' : 'text-gray-800 hover:text-blue-600' }} transition-colors duration-300">Booking</a></li>
        ...
        <div id="mobile-menu" class="md:hidden transition-all duration-300 ease-in-out max-h-0 opacity-0 overflow-hidden">
            <div class="py-4 space-y-4">
                ...
                <a href="{{ route('booking.page') }}" class="block font-medium {{ request()->routeIs('booking.page') ? 'text-blue-600' : 'text-gray-800 hover:text-blue-600' }} transition-colors duration-300">Booking</a>
