<nav class="max-w-screen-lg mx-auto py-4 flex items-center justify-between gap-4">
    <div class="text-2xl font-semibold text-text-dark">Flivan</div>
    ...
    <button
        class="px-8 py-3 text-white bg-primary rounded-full font-medium hover:bg-primary-dark transition duration-300">Contact</button>
</nav>
