...
<div class="min-h-[80vh] pt-16">
    <div class="max-w-5xl mx-auto p-4 md:p-6">
        ...
        <div class="no-print bg-white rounded-2xl shadow-lg border-2 border-gray-200/50 backdrop-blur-sm p-8 mb-8 animate-slide-up">
            <div class="mb-10">
        ...
        <div id="print-section" class="bg-white rounded-2xl shadow-lg border-2 border-gray-200/50 backdrop-blur-sm p-8 mb-8">
            <div class="mb-10">
                <h3 class="text-xl font-semibold text-gray-700 mb-4">E-Ticket</h3>

                @foreach($booking_passenger as $index => $passenger)
                    <div class="ticket-container relative bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-lg mb-6">
            ...
            <div class="no-print flex flex-col sm:flex-row justify-center gap-4 mt-10 pt-6 border-t border-gray-100">
                <a href="{{ route('booking-history.index') }}" class="inline-flex items-center justify-center px-8 py-3 rounded-xl text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-200 font-medium">
                    <i class="fas fa-arrow-left mr-2"></i>
                    Back
                </a>
                <button onclick="window.print()" class="inline-flex items-center justify-center px-8 py-3 rounded-xl text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors duration-200 font-medium">
