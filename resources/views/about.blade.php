    ...
    <section class="px-6 max-w-screen-lg mx-auto pt-24">
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        <i class="fa-solid fa-plane text-green-500"></i>
        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
            <div class="space-y-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        <i class="fa-solid fa-plane-departure text-green-500"></i>
                        <span class="text-gray-700">Setting New Standards in Air Travel</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <i class="fa-solid fa-ticket-alt text-green-500"></i>
                    ...
                    <div class="flex items-center gap-3">
                        <i class="fa-solid fa-smile text-green-500"></i>
